...
export function Dashboard({}: DashboardProps) {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setSubscribeMessage('Thank you for subscribing to the PULSE newsletter!');
      setEmail('');
      ...
      <div className="container mx-auto px-4 py-8 mt-16 relative z-10">
        ...
        <div className="border-b-4 border-green-400/70 mb-6 pb-4">
          <div className="flex justify-between items-center">
            <h1 className="text-5xl font-bold tracking-tight font-serif">PULSE</h1>
        ...
        {/* Grok AI Digest Banner */}
        <div className="bg-black/60 border-2 border-blue-400/70 rounded-lg p-4 mb-4 backdrop-blur-sm">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0 md:mr-4">
              <h3 className="text-xl font-bold font-serif text-blue-400">Grok AI News Digest</h3>
              <p className="text-blue-300/70">Weekly digest of viral and valuable AI topics powered by xAI&apos;s Grok</p>
            </div>
            <Link
              href="/news/grok-digest"
              className="bg-blue-400/80 text-black font-bold px-4 py-2 rounded hover:bg-blue-300/80 transition-colors"
            >
              View Digest
            </Link>
          </div>
            ...
            {featuredNews && (
              <div className="bg-black/40 border-2 border-green-400/30 rounded-lg p-6 backdrop-blur-sm">
                ...
                <div className="text-sm text-green-400/60">
                  ...
                  {featuredNews.importance_score && (
                    <>
                      <span className="mx-2">•</span>
                      <span className="text-yellow-400">
                        Impact Score: {Math.round(featuredNews.importance_score)}
                      </span>
                    </>
                  )}
                </div>
        ...
        <div className="mt-12 pt-6 border-t-4 border-green-400/50 text-center">
          <p className="text-green-300/70">
            PULSE - Your comprehensive source for AI news, trends, and insights
          </p>
        </div>
      </div>
    </div>
